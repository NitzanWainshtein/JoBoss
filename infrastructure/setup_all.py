...
def finalize(pool_id, client_id, api_url, cloudfront_url):
    ...
    env_path.write_text(
        f"# Generated by setup_all.py — official install values for this AWS account\n"
        ...
        f"# Optional: set if using Google SSO (requires Cognito hosted domain)\n"
        f"# VITE_COGNITO_DOMAIN=\n"
    )

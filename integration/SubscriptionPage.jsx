...
const STATUS_MAP = {
  ACTIVE:         { label: 'פעיל',           color: '#12A96F', bg: '#EBFBF2' },
  TRIAL:          { label: 'ניסיון חינם',    color: '#F5A623', bg: '#FFF3E0' },
  EXPIRED:        { label: 'פג תוקף',        color: '#FF4D67', bg: '#FFEBEE' },
  CANCELLED:      { label: 'בוטל',           color: '#8B8299', bg: '#F5F3FC' },
  PAYMENT_FAILED: { label: 'תשלום נכשל',     color: '#FF4D67', bg: '#FFEBEE' },
  BLOCKED:        { label: 'חסום',           color: '#FF4D67', bg: '#FFEBEE' },
  FREE:           { label: 'חינמי',          color: '#8B8299', bg: '#F5F3FC' },
};
